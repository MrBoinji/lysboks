/*! lysboks_admin - v0.0.1 - 2014-12-30
...
(function() {
  ...
  app.directive('lsHeader', function() {
    return {
      restrict: 'E',
      templateUrl: 'app/header.tpl.html',
      controller: function() {
        return this.testVar = '03:17';
      },
      controllerAs: 'header'
    };
  });
...
angular.module('templates-admin', ['../app/header.tpl.html']);

angular.module("../app/header.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../app/header.tpl.html",
    "<div class=\"navbar\">\n" +
    "	<h1>{{header.testVar}}</h1>\n" +
    "	<h2>TEMPLATE IST DA</h2>\n" +
    "\n" +
    "	<!--<div class=\"navbar-inner\">-->\n" +
    "		<!--<a class=\"lb_brand\" ng-click=\"home()\">AScrum</a>-->\n" +
    "		<!--<ul class=\"nav\">-->\n" +
